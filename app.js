ï»¿// Cat+Ã­logo inicial local. Ser+Ã­ reemplazado por datos desde la API/Sheet.
let products = [
  {
    id: "hook-pro",
    name: "Hook Pro 12cm",
    ...
    size: "12 cm",
    badge: "Top seller",
    description: "Gancho blistero galvanizado para retail y exhibidores de alto tr+Ã­fico.",
    imageLabel: "PRO",
    colors: [
  ...
  },
  {
    ...
    images: ["Pack completo", "Detalle blister", "Aplicaci+Â¦n en g+Â¦ndola"]
  },
  {
    id: "display-led",
    ...
    size: "8 cm",
    badge: "Premium",
    description: "Rack con iluminaci+Â¦n integrada y passthrough de cables oculto.",
    imageLabel: "LED",
    colors: [
      { name: "Negro", hex: "#0e0e12" },
      { name: "Blanco", hex: "#f7f7f9" }
    ],
    images: ["Vista frontal", "Back panel", "Detalle iluminaci+Â¦n"]
  },
  {
    id: "gancho-mini",
    name: "Hook Mini 7cm",
...
let combos = [
  { id: "combo-8-50", name: "Combo 50 ganchos 8cm", price: 180000, size: "8 cm", badge: "Combo", description: "Pack de 50 ganchos blistero de 8cm listo para PDV.", imageLabel: "50x 8cm", colors: [{ name: "Negro", hex: "#111" }, { name: "Rojo", hex: "#e03232" }], images: ["Combo 50", "Detalle color", "Aplicaci+Â¦n"] },
  { id: "combo-8-100", name: "Combo 100 ganchos 8cm", price: 340000, size: "8 cm", badge: "Combo", description: "Pack de 100 ganchos blistero de 8cm con ahorro extra.", imageLabel: "100x 8cm", colors: [{ name: "Negro", hex: "#111" }, { name: "Rojo", hex: "#e03232" }], images: ["Combo 100", "Detalle color", "Aplicaci+Â¦n"] },
  { id: "combo-8-200", name: "Combo 200 ganchos 8cm", price: 650000, size: "8 cm", badge: "Combo", description: "Pack de 200 ganchos blistero de 8cm para grandes vol+Â¦menes.", imageLabel: "200x 8cm", colors: [{ name: "Negro", hex: "#111" }, { name: "Rojo", hex: "#e03232" }], images: ["Combo 200", "Detalle color", "Aplicaci+Â¦n"] },
  { id: "combo-12-50", name: "Combo 50 ganchos 12cm", price: 210000, size: "12 cm", badge: "Combo", description: "Pack de 50 ganchos blistero de 12cm para reposici+Â¦n r+Ã­pida.", imageLabel: "50x 12cm", colors: [{ name: "Negro", hex: "#121212" }, { name: "Rojo", hex: "#ef2b2d" }], images: ["Combo 50", "Detalle color", "Aplicaci+Â¦n"] },
  { id: "combo-12-100", name: "Combo 100 ganchos 12cm", price: 380000, size: "12 cm", badge: "Combo", description: "Pack de 100 ganchos blistero de 12cm con mejor precio por unidad.", imageLabel: "100x 12cm", colors: [{ name: "Negro", hex: "#121212" }, { name: "Rojo", hex: "#ef2b2d" }], images: ["Combo 100", "Detalle color", "Aplicaci+Â¦n"] },
  { id: "combo-12-200", name: "Combo 200 ganchos 12cm", price: 720000, size: "12 cm", badge: "Combo", description: "Pack de 200 ganchos blistero de 12cm para proyectos grandes.", imageLabel: "200x 12cm", colors: [{ name: "Negro", hex: "#121212" }, { name: "Rojo", hex: "#ef2b2d" }], images: ["Combo 200", "Detalle color", "Aplicaci+Â¦n"] }
];
...
function getShipping(subtotal) {
  ...
  // EnvÃ­o fijo si el subtotal es bajo, gratis si supera el umbral
...
function renderCart() {
  ...
  if (!items.length) {
    cartList.innerHTML = '<div class="empty">Todav+Â¡a no agregaste productos.</div>';
...
function renderCheckoutSummary() {
  ...
  const items = Object.values(cart);
  if (!items.length) {
    checkoutSummary.innerHTML = '<div class="empty">El carrito estÃ¡ vacÃ­o.</div>';
  ...
  checkoutTotals.innerHTML = `
    ...
    <div class="totals__row"><span>EnvÃ­o</span><strong>${shipping === 0 ? "Gratis" : formatCurrency(shipping)}</strong></div>
...
async function handleCheckout() {
  ...
  const payload = {
    ...
    notes: pickupToggle?.checked ? "Retiro en local" : "Pedido web pendiente de confirmaciÂ¾n",
  };
  try {
    showLoader();
    ...
    alert("No se pudo enviar el pedido o crear el pago. Reintenta o contÃŸctanos.");
  } finally {
    hideLoader();
  }
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (continueBtn) {
    continueBtn.addEventListener("click", () => {
      ...
      if (currentStep === 2) {
        if (!isCheckoutReady()) {
          alert("Completa nombre, telÃ©fono y email antes de continuar.");
          return;
        }
        goToStep(3);
      }
    ...
    contactForm.addEventListener("submit", (e) => {
      ...
      fetch(CONTACT_URL, {
        ...
        .then(() => {
          ...
          alert("No se pudo enviar. Reintenta o escr+Â¡benos a ventas@ganchosblistero.com");
        });
    });
  }
...
async function fetchCatalog() {
  ...
  const sanitizeItem = (item) => {
    ...
    if (typeof val === "string") {
      ...
      // Si es un string simple (URL o texto), lo devolvemos como array de un elemento
      return [val];
    }
    return fallback;
  };
  ...
  try {
    ...
    console.warn("No se pudo obtener el catÃ¡logo remoto, se usan datos locales.", error);
  } finally {
